...
int main() {
	...
	char* keyArray[10] = {"GuLu", "Lighting", "Timi", "Dpdk", "Io", "Ntyco", "Os", "Net", "Hi", "Hello"};
	char* valueArray[10] = {"1GuLu", "2Lighting", "3Timi", "4Dpdk", "5Io", "6Ntyco", "7Os", "8Net", "9Hi", "10Hello"};
...
int kvs_rbtree_set(kvs_rbtree_t *inst, char *key, char *value)
{
	...
	/* 先检查 key 是否已存在，避免内存泄漏 */
	rbtree_node *existing = rbtree_search(inst, key);
	if (existing && existing != inst->nil)
	{
